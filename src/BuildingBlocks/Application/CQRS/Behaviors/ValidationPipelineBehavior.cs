...
{
    private readonly IEnumerable<FluentValidation.IValidator<TMessage>> _validators;

    public ValidationPipelineBehavior(IEnumerable<FluentValidation.IValidator<TMessage>> validators)
    {
