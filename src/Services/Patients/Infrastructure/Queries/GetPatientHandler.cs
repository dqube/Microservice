...
using CompanyName.MyProjectName.Patients.Application.Patients.Queries;
using CompanyName.MyProjectName.Patients.Infrastructure.DAL;
using CompanyName.MyProjectName.Patients.Infrastructure.DAL.Mappings;
using Microsoft.EntityFrameworkCore;

namespace CompanyName.MyProjectName.Patients.Infrastructure.Queries;
